...
hardSwitch.addEventListener("change", function () {
    ...
    guesses = [];
    let gridHTML =
        '<div class="grid-header">Track Name</div><div class="grid-header">Album</div><div class="grid-header">Track Number</div><div class="grid-header">Track Length</div><div class="grid-header">Features</div>';
